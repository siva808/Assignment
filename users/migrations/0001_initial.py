# Generated by Django 4.2.15 on 2024-09-28 11:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('axis_name', models.CharField(choices=[('X', 'X'), ('Y', 'Y'), ('Z', 'Z')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('axis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.axis')),
        ...
        migrations.AddField(
            model_name='axis',
            name='machine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='axes', to='users.machine'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'SUPERADMIN'), ('manager', 'Manager'), ('supervisor', 'Supervisor'), ('operator', 'Operator')], max_length=20)),
